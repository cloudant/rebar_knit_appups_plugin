...
get_priority(Name, Attrs) ->
    case get_attr(rebar_knit_priority, Attrs) of
        [P] when is_integer(P) ->
            P;
        undefined ->
            0;
...
get_extra(Name, Attrs) ->
    case get_attr(rebar_knit_extra, Attrs) of
        [E] ->
            {advanced, E};
        undefined ->
            soft;
...
get_depends(Name, Attrs) ->
    case get_attr(rebar_knit_depends, Attrs) of
...
get_timeout(Name, Attrs) ->
    case get_attr(rebar_knit_timeout, Attrs) of
        [default] ->
            default;
        [infinity] ->
            infinity;
...
get_purge(Name, Attrs) ->
    case get_attr(rebar_knit_purge, Attrs) of
        [soft_purge] ->
...
get_apply_funs(Name, Attrs) ->
    case get_attr(rebar_knit_apply, Attrs) of
        undefined ->
            [];
        Funs ->
